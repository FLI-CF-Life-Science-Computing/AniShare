...
class Job(HourlyJob):
    ...
    def execute(self):
        ...
        from ...models import WIncident, WIncident_write, WIncidentAnimals, Animal, Mouse, MouseAll, Pup, MouseMutation, Location, Person, Lab, WIncidentPups
        from ...models import Comment, Comment_work_request_ref, PyratUser
